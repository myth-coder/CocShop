...
public class UpdateAccountServlet extends HttpServlet {
    ...
    private static final String INVALID = "profile.jsp";
    private static final String SUCCESS = "UpdateProfileSuccess.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(phoneNumber.trim().length() == 0 ||phoneNumber.trim().length()!= 10 || !phoneNumber.trim().matches("^[0-9]*$")){
                error = true;
